...
function copy(object) {
  if (Array.isArray(object)) {
    ...
    return Object.assign(Object.create(prototype || null), object)
  } else {
    return object
  }
}
...
function newContext() {
  const commands = Object.assign({}, defaultCommands)
